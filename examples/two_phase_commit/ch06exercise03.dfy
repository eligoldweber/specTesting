...
/*{*/
    ...
    && (forall idx:ParticipantId | c.ValidParticipant(idx) :: v.participantDecisions[idx].Some? ==> v.participantDecisions[idx].value == decision)
/*}*/
  }
  ...
  {
/*{*/
    && (forall idx:ParticipantId | c.ValidParticipant(idx) :: v.participantDecisions[idx].Some? ==> AllWithDecisionAgreeWithThisOne(c, v, v.participantDecisions[idx].value))
    && (v.coordinatorDecision.Some? ==> AllWithDecisionAgreeWithThisOne(c, v, v.coordinatorDecision.value))
/*}*/
  }
  ...
  {
/*{*/
    (exists idx:ParticipantId | c.ValidParticipant(idx) :: v.participantDecisions[idx].Some? && v.participantDecisions[idx].value == Commit) || (v.coordinatorDecision.Some? && v.coordinatorDecision.value == Commit)
    ==> forall idx:ParticipantId | c.ValidParticipant(idx) :: c.preferences[idx] == Yes
/*}*/
  }
  ...
  {
/*{*/
    (forall idx:ParticipantId | c.ValidParticipant(idx) :: c.preferences[idx] == Yes) ==> AllWithDecisionAgreeWithThisOne(c, v, Commit)
/*}*/
  }
