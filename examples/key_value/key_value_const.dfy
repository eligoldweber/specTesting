...
module MapSpec {
  ...
  predicate InsertOp(v:Variables, v':Variables, key:Key, value:Value)
  {
    ...
    && v'.mapp == v.mapp[key := DefaultValue()]
  }
...
/*}*/
  ...
  {
/*{*/
    MapSpec.Variables(map key | key in KnownKeys(c, v) :: DefaultValue())
/*}*/
  }
...
/*{*/
    ...
    assert MapSpec.NextStep(Abstraction(c, v), Abstraction(c, v'), MapSpec.QueryOpStep(key, DefaultValue()));
